...
4. Expand end-to-end and frontend coverage.
5. Develop Marina personality, memory systems, content, emotions, activities and mini-games.
6. Production readiness and release monitoring.
